...
contract StarNotary is ERC721 {
    ...
    function createStarWithNameAndSymbol(string memory _name, string memory _symbol, uint256 _tokenId) public {
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        if(msg.value > starCost) {
            address payable senderPayable = _make_payable(msg.sender);
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, "Only the owner can cll this function");
    ...
    // The owner of the star wants to transfer the ownership to another account
    function transferStar(address _to1, uint256 _tokenId) public {
        //1. Check if the sender is the ownerOf(_tokenId)
        address starOwner = ownerOf(_tokenId);
        require(starOwner == msg.sender);

        //TODO: make sure the owner has enough balance more than the gas fee ?
